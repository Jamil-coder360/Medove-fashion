  ...
  return (
    <section>
      <div className="container">
        <div style={bgImage} className="pt-30 lg:pt-55 px-10 lg:px-27.25 pb-20 lg:pb-60.5">
          <div className="flex flex-col items-start justify-center max-w-[624px] gap-5">
            <h1 className="text-[32px] lg:text-[64px] font-medium font-jost leading-[1.5] tracking-[0.46%] text-black-222">
              Fresh Looks for Warmer Days
            </h1>
            <p className="text-[16px] lg:text-[20px] font-normal font-jost leading-[1.5] tracking-[0.46%] text-black-222 max-w-[496px]">
