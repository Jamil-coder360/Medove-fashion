  ...
  return (
    <section>
      <div className="container py-20">
        <div
          style={bgImage}
          className="flex flex-col items-center justify-center  py-25  text-center"
        >
          <h1 className="font-jost font-medium text-[64px] leading-[1.4] max-w-[597px] pb-5">
            Fresh Looks for Sunny Days
          </h1>
          <p className="font-jost font-normal text-[20px] leading-[1.4] max-w-[597px] pb-10">
